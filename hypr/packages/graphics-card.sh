...
2)
  sudo pacman -Rns --noconfirm nvidia-open-dkms nvidia-utils nvidia-settings qt5-wayland qt5ct qt6-wayland qt6ct libva && yay --noconfirm -Rns libva-nvidia-driver-git
